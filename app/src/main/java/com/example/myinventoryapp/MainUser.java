...
import com.example.myinventoryapp.adapter.UserAdapter;
import com.example.myinventoryapp.model.User;
...
public class MainUser extends AppCompatActivity {
    ...
    //inisialisasi object firebase firestore untuk menghubungkan dengan firebase
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), EditorUser.class));
        });
    }
    @Override
